...
import { JobFormData } from '@/types/job';
import theme from '@/theme';
import LanguageSelectDialog from '../freelancer/LanguageSelectDialog'; // Import the LanguageSelectDialog
import { LanguagePair } from '@/types/language'; // Import the LanguagePair type
...
export default function CreateJob({ open, onClose }: CreateJobProps) {
  ...
  const [errorMessage, setErrorMessage] = React.useState<string | null>(null);
  const [csvFileName, setCsvFileName] = React.useState<string | null>(null);
  const [languageDialogOpen, setLanguageDialogOpen] = React.useState(false); // State for language dialog
  const [selectedLanguagePair, setSelectedLanguagePair] = React.useState<LanguagePair | null>(null); // State for selected language pair
